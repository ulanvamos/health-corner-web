...
export default function LoginPage() {
  ...
  function quickLogin(email: string, password = "password123") {
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-[#f9fafb]">
        <div className="max-w-[440px] mx-auto w-full">
          ...
          {/* Quick Demo Section */}
          <section className="mt-12 pt-10 border-t border-[rgba(47,44,40,0.06)]">
            <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted)] mb-6">Hızlı Demo Girişi</p>
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={() => quickLogin("elif@healthcorner.demo")}
                className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-[rgba(47,44,40,0.06)] hover:border-[var(--accent)] hover:bg-[var(--accent-soft)] transition-all group"
              >
                <div className="w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover:bg-[var(--accent)] group-hover:text-white transition-all">
                  <Stethoscope size={20} />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted)]">Diyetisyen</span>
              </button>
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-[rgba(47,44,40,0.06)] hover:border-[var(--accent)] hover:bg-[var(--accent-soft)] transition-all group"
              >
                <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-[var(--accent)] group-hover:text-white transition-all">
                  <ShieldCheck size={20} />
                </div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--muted)]">Admin</span>
              </button>
            </div>
          </section>
